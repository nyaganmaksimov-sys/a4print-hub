const CACHE='a4print-pos-v3';
const CORE=['./','./index.html','./styles-v2.css','./runtime-guard.js','./app-v2.js','./manifest.webmanifest','./login.html','./login.js','../admin/config.js','../admin/assets/a4print-hub-logo.png'];
