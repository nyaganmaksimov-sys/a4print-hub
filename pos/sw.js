const CACHE='a4print-pos-v2';
const CORE=['./','./index.html','./styles-v2.css','./app-v2.js','./manifest.webmanifest','./login.html','./login.js','../admin/config.js','../admin/assets/a4print-hub-logo.png'];
