const CACHE='a4print-kassa-v35';
const CORE=[
  './','./index.html','./styles.css','./modules.css','./shift.css','./shift-layout-fix.css','./shift-profile.css','./shift-compact.css','./sale-finish.css','./config.js','./db.js','./bootstrap.js','./network-safety.js','./shift-session-gate.js','./sync-throttle.js','./app.js','./modules.js','./ui.js','./catalog-quick-add.js','./shift-operator.js','./shift-state-sync.js','./shift-profile.js','./shift-profile-compact.js','./cash-operations.js','./sale-submit-guard.js','./sale-finish.js','./return-finish.js','./history-hub.js','./held-receipts.js','./report-source-summary.js','./settings-help.js','./sale-view-fix.js','./startup-shift.js','./runtime-stability.js','./manifest.webmanifest',
