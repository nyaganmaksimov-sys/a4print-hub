const CACHE='a4print-kassa-v22';
const CORE=[
  './','./index.html','./styles.css','./modules.css','./shift.css','./shift-layout-fix.css','./sale-finish.css','./config.js','./db.js','./bootstrap.js','./network-safety.js','./shift-session-gate.js','./app.js','./modules.js','./ui.js','./shift-operator.js','./shift-state-sync.js','./sale-submit-guard.js','./sale-finish.js','./sale-view-fix.js','./startup-shift.js','./manifest.webmanifest',
