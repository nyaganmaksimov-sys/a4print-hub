const CACHE='a4print-kassa-v15';
const CORE=[
  './','./index.html','./styles.css','./modules.css','./shift.css','./shift-layout-fix.css','./config.js','./db.js','./bootstrap.js','./network-safety.js','./shift-session-gate.js','./app.js','./modules.js','./ui.js','./shift-operator.js','./shift-live.js','./shift-state-sync.js','./manifest.webmanifest',
