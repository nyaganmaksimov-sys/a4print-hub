const CACHE='a4print-kassa-v10';
const CORE=[
  './','./index.html','./styles.css','./modules.css','./shift.css','./config.js','./db.js','./bootstrap.js','./app.js','./modules.js','./ui.js','./shift-operator.js','./shift-live.js','./manifest.webmanifest',
