-- Partner quote hardening: external users cannot choose the authoritative HUB order total.
-- Their optional estimate is stored only as a parameter for the manager.
...
begin
  ...
  v_parameters := coalesce(p_parameters,'{}'::jsonb) || jsonb_build_object(
