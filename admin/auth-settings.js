(()=>{
  ...
  const start=async()=>{
    ...
    const style=document.createElement('style');style.textContent=`
      .auth-settings-card{margin-top:20px}.auth-methods{display:grid;gap:10px;margin-top:14px}.auth-method{display:grid;grid-template-columns:minmax(170px,1fr) 110px 130px 140px;align-items:center;gap:12px;padding:13px 14px;border:1px solid #e2e8f0;border-radius:14px;background:#f8fafc}.auth-method-name{display:flex;align-items:center;gap:10px;font-weight:900;color:#172033}.auth-method-icon{width:34px;height:34px;border-radius:10px;background:#fff;border:1px solid #e2e8f0;display:grid;place-items:center}.auth-toggle{display:flex;align-items:center;gap:8px;font-size:12px;font-weight:800;color:#334155}.auth-toggle input{width:18px;height:18px;accent-color:#2563eb}.auth-status{justify-self:start;display:inline-flex;align-items:center;gap:6px;padding:6px 9px;border-radius:999px;font-size:11px;font-weight:900;background:#e2e8f0;color:#475569}.auth-status.ok{background:#dcfce7;color:#166534}.auth-status.bad{background:#fee2e2;color:#b91c1c}.auth-status.wait{background:#fef3c7;color:#92400e}.auth-actions{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-top:14px}.auth-settings-msg{font-size:12px}.auth-settings-msg.ok{color:#15803d}.auth-settings-msg.err{color:#b91c1c}@media(max-width:760px){.auth-method{grid-template-columns:1fr 1fr}.auth-method-name{grid-column:1/-1}.auth-status{grid-column:1/-1}}
