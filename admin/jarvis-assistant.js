...
function build(){
  ...
  #jarvisPanel.open{display:grid}.jarvis-head{padding:14px 15px;border-bottom:1px solid #e5e7eb;display:flex;align-items:center;justify-content:space-between;gap:10px;background:#0f172a;color:#fff}.jarvis-head b{display:block;font-size:16px}.jarvis-head small{opacity:.75}.jarvis-head-actions{display:flex;align-items:center;gap:7px}.jarvis-head button{border:0;border-radius:9px;background:rgba(255,255,255,.12);color:#fff;padding:7px 9px;cursor:pointer}.jarvis-head select{height:34px;min-height:34px!important;border:1px solid rgba(255,255,255,.18)!important;background:#1e293b!important;color:#fff!important;border-radius:9px!important;padding:0 8px!important;font-size:12px;box-shadow:none!important}
  ...
  @media(max-width:700px){#jarvisLauncher{right:78px;bottom:14px}#jarvisPanel{right:14px;bottom:80px;height:min(72vh,570px)}.jarvis-head select{max-width:108px}}`;
