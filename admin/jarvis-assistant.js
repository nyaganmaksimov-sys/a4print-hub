...
function build(){
  ...
  #jarvisPanel{position:fixed;right:22px;bottom:92px;z-index:12049;width:min(390px,calc(100vw - 28px));height:min(590px,calc(100vh - 120px));display:none;grid-template-rows:auto 1fr auto;background:#fff;border:1px solid #dbe2ea;border-radius:20px;box-shadow:0 28px 80px rgba(15,23,42,.3);overflow:hidden}
  ...
  @media(max-width:700px){#jarvisLauncher{right:78px;bottom:14px}#jarvisPanel{right:14px;bottom:80px;height:min(70vh,560px)}}`;
