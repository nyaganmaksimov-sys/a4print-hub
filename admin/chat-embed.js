(function(){
  ...
  style.textContent=`
    ...
    html.a4-chat-embed .sidebar,html.a4-chat-embed .topbar,html.a4-chat-embed .rooms,html.a4-chat-embed .a4-theme-fab,html.a4-chat-embed .a4-theme-panel,html.a4-chat-embed .a4-help-btn,html.a4-chat-embed .a4-help-pop,html.a4-chat-embed .a4-layout-toolbar,html.a4-chat-embed #hubChatNotifyCenter,html.a4-chat-embed #a4NotificationWrap,html.a4-chat-embed .a4-mobile-nav,html.a4-chat-embed .a4-mobile-nav-shade,html.a4-chat-embed .a4qm-panel,html.a4-chat-embed .a4qm-backdrop{display:none!important}
    ...
    html.a4-chat-embed .chat{display:grid!important;grid-template-rows:auto minmax(0,1fr) auto!important;height:100dvh!important;min-height:0!important;overflow:hidden!important}
    ...
    html.a4-chat-embed .messages{min-height:0!important;padding:10px!important;gap:8px!important;background:#fbfdff!important;overflow:auto!important}
    ...
    html.a4-chat-embed .composer{display:grid!important;grid-template-columns:40px minmax(0,1fr) 42px!important;gap:6px!important;padding:8px!important;border-top:1px solid #e5e7eb!important;background:#fff!important;align-items:end!important;position:relative!important;z-index:5!important;visibility:visible!important;opacity:1!important}
    html.a4-chat-embed .attach-btn{display:grid!important;place-items:center!important;width:40px!important;height:42px!important;border-radius:11px!important;font-size:17px!important}
    html.a4-chat-embed .composer textarea{display:block!important;width:100%!important;min-width:0!important;min-height:42px!important;max-height:92px!important;padding:9px 10px!important;border-radius:11px!important;font-size:14px!important;line-height:1.3!important;visibility:visible!important;opacity:1!important}
    html.a4-chat-embed .send{display:block!important;width:42px!important;height:42px!important;min-height:42px!important;padding:0!important;border-radius:11px!important;font-size:0!important}
