...
(function loadHubUi(){
  ...
  load('navigation.js','20260909-equipment1');load('support-access.js','20260913-expenses1');load('onboarding.js','20260905-1');load('workspace-clean.js','20260908-profile1');load('topbar-modern.js','20260908-3');load('nav-accordion.js','20260909-equipment1');load('modern-ui.js','20260904-1');if(!isManager){load('workspace-popup.js','20260912-1');load('workspace-popup-coverage.js','20260912-3')}loadModule('equipment-maintenance-badge.js','20260912-orders1');
