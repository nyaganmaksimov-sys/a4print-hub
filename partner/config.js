...
(function loadPartnerUi(){
  ...
  if (!/\/partner\/login\.html$/.test(location.pathname)) scripts.push('../admin/layout.js?v=20260831-5','./help.js?v=20260831-1','./crm-entry.js?v=20260831-1','./marketplace-nav.js?v=20260831-1');
  scripts.forEach(src=>{
